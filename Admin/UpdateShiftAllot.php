...
<head>
      ...
      <title>Update Shift Allot</title>
            	...
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel m-auto">
                        	<div class="x_title">
                              <h2>Update Shift Allot</h2>
                              <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="UpdateShiftAllotCode.php">
                                	<?php
										require("../MyDB.php");
										
										$ID=$_GET['ID'];
										
										$Query="select * from ((tbl_shiftallot INNER JOIN tbl_employee ON tbl_employee.EmployeeID=tbl_shiftallot.EmployeeID) INNER JOIN tbl_shift ON tbl_shift.ShiftID=tbl_shiftallot.ShiftID)  where ShiftAllotID='$ID'";
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select name="ShiftID" class="form-control">
                                    	<option value="<?php echo $ShiftID;?>"><?php echo $ShiftName;?></option>
                                    	<?php
											require("../MyDB.php");
