...
<head>
      ...
      <title>View Product Sell By Emplyoee</title>
                	...
                	<div class="clearfix"></div>
                    	<div class="row">
                    		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center-block" style="float:none">
                            	<div class="x_panel">
                                	<div class="x_title">
                                      <h2>View Product Sell By Emplyoee</h2>
                                      <div class="clearfix"></div>
                                   </div>
                                   		...
                                   		<table class="table table-bordered">
                                            ...
                                            <tbody>
                                            	<?php
														...
														$Query="SELECT * FROM ((tbl_selling INNER JOIN tbl_product ON tbl_product.ProductID=tbl_selling.ProductID) INNER JOIN tbl_employee ON tbl_employee.EmployeeID=tbl_selling.EmployeeID)";
