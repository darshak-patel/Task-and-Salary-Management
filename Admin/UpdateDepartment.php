            	...
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel m-auto">
                            ...
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="UpdateDepartmentCode.php">
                                	 <?php
										require("../MyDB.php");
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" name="DepartmentName" value="<?php echo $DepartmentName; ?>" class="form-control" required="">
                                 </div>
