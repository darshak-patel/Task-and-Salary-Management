                                   ...
                                   <div class="x_content">
                                   		<table class="table table-bordered">
                                            ...
                                            <tbody>
												...
												?>
                                            	<tr>
                                                	<td><?php echo "<a class='btn btn-danger' href='DeleteDesignation.php?ID=$ID'>Delete</a>"; ?></td>
                                                    <td><?php echo "<a class='btn btn-info' href='UpdateDesignation.php?ID=$ID'>Update</a>"; ?></td>
