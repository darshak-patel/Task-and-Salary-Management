            	...
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel">
                            ...
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="AddAdminCode.php">
                                 <div class="form-group">
                                    <label>Username</label>
                                    <input type="text" id="UsernameA" name="Username" placeholder="Enter Department Name" class="form-control" required="">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="password" name="Password" placeholder="Enter Department Name" class="form-control" required="">
                                 </div>
