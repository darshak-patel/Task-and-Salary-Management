                                   ...
                                   <div class="x_content">
                                   		<table class="table table-bordered">
                                            ...
                                            <tbody>
												...
												?>
                                            	<tr>
                                                	<td><?php echo "<a class='btn btn-danger' href='DeleteDepartment.php?ID=$ID'>Delete</a>"; ?></td>
                                                    <td><?php echo "<a class='btn btn-info' href='UpdateDepartment.php?ID=$ID'>Update</a>"; ?></td>
