            	...
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel m-auto">
                            ...
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="AddDesignationCode.php">
                                 <div class="form-group">
                                    <label>Designation Name</label>
                                    <input type="text" name="DesignationName" placeholder="Enter Designation Name" class="form-control" required="">
                                 </div>
