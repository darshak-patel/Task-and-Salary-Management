         ...
         <div class="main_container">
			...
			?>
             <?php
				...
				$Query="select * from tbl_designation where DesignationID='$ID'";
            	...
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel m-auto">
                            ...
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="UpdateDesignationCode.php">
                                 <div class="form-group">
                                    <label>Designation Name</label>
                                    <input type="hidden" name="ID" class="form-control" value="<?php echo $ID; ?>" />
                                    <input type="text" name="DesignationName" value="<?php echo $DesignationName; ?>" class="form-control" required="">
                                 </div>
