...
<head>
      ...
      <title>View Emplyoee Attandance</title>
                                   ...
                                   <div class="x_content table-responsive">
                                   		...
                                   		<table class="table table-bordered">
                                            ...
                                            <tbody>
												...
												?>
                                            	<tr>
                                                	<td><?php echo "<a class='btn btn-danger' href='DeleteAttandance.php?ID=$ID'>Delete</a>"; ?></td>
                                                    <td><?php echo "<a class='btn btn-info' href='UpdateEmplyoeeAttandance.php?ID=$ID'>Update</a>"; ?></td>
                                                	<td><?php echo $row['AttendanceID']; ?></td>
                                                    <td><?php echo $row['Date']; ?></td>
                                                    <td><?php echo $row['EmployeeID']; ?></td>
                                                    <td><?php echo $row['AttendancePA']; ?></td>
