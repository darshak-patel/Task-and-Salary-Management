...
<head>
      ...
      <title>Update Selling Product Target Team Leader</title>
         ...
         <div class="main_container">
			...
			?>
             <?php
				...
				$Query="SELECT * FROM (((tbl_sellingtargetleader INNER JOIN tbl_product ON tbl_product.ProductID=tbl_sellingtargetleader.ProductID) INNER JOIN tbl_employee ON tbl_employee.EmployeeID=tbl_sellingtargetleader.EmployeeID) INNER JOIN tbl_designation ON tbl_designation.DesignationID=tbl_employee.DesignationID) where Username='$EmployeeUsername' and TargetTeamLeaderID='$ID'";
            ...
            <div class="right_col" role="main">
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel">
                        	<div class="x_title">
                              <h2>Update Selling Product Target</h2>
                              <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="UpdateSellingProductTMCode.php">
