...
<head>
      ...
      <title>View Shift Approved</title>
                                   		...
                                   		<table class="table table-bordered">
                                            ...
                                            <tbody>
                                            	<?php
														...
														$Query="SELECT * FROM tbl_shiftchangerequest INNER JOIN tbl_employee ON tbl_employee.EmployeeID=tbl_shiftchangerequest.EmployeeID WHERE Username='$EmployeeUsername'";
