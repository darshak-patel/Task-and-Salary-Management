            	...
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel">
                            ...
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="LeaveAppYN.php">
                                	<?php
										require("../MyDB.php");
																		
										$ID=$_GET['ID'];
																	
										$Query1="SELECT * FROM tbl_leaverequest INNER JOIN tbl_employee ON tbl_employee.EmployeeID=tbl_leaverequest.EmployeeID WHERE LeaveRequestID='$ID'";
                                    ...
                                    <input type="hidden" name="ID" value="<?php echo $ID; ?>">
                                        ...
                                        <div class="form-group">
                                             ...
                                             <input type="date" name="DateFrom" value="<?php echo $DateFrom; ?>" class="form-control" readonly="readonly">
                                        </div>
                                        <div class="form-group">
                                             <label>Date To</label>
                                             <input type="date" name="DateTo" value="<?php echo $DateTo; ?>" class="form-control" readonly="readonly">
                                        </div>
                                        <div class="form-group">
                                             <label>Remarks</label>
                                     <textarea type="text" name="Remarks" rows="3" placeholder="Enter Leave Reason" class="form-control" readonly><?php echo $Remarks; ?></textarea>
                                        </div>
                                        <div class="form-group">
