...
<?php
	...
	$Query="INSERT INTO `tbl_sellingtargetleader`(`ProductID`, `ProductPrice`,`Target`, `EmployeeID`, `SellDate`) VALUES ('$ProductID','$ProductPrice','$Target','$EmployeeID','$SellDate')";
...
<body onLoad="JSconfirm()">
    <script type="text/javascript">
    	...
    	.then((willDelete) => {
      	if(willDelete) 
		{
         	window.location = "AddSellingProductTarget.php";     
        }  
        else 
		{
        window.location = "AddSellingProductTarget.php";     
