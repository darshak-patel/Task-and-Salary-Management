                                   		...
                                   		<table class="table table-bordered">
                                            ...
                                            <tbody>
                                            	<?php
														...
														$Query="select * from  tbl_targetassignteamleader INNER JOIN tbl_employee ON tbl_employee.EmployeeID=tbl_targetassignteamleader.EmployeeID WHERE Username='$EmployeeUsername'";
