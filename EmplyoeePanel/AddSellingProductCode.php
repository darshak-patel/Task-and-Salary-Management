...
<?php
	...
	$Query="INSERT INTO `tbl_selling`(`ProductID`, `ProductPrice`,`Target` `EmployeeID`, `SellDate`) VALUES ('$ProductID','$ProductPrice','$Target','$EmployeeID','$SellDate')";
...
<body onLoad="JSconfirm()">
    <script type="text/javascript">
    	...
    	.then((willDelete) => {
      	if(willDelete) 
		{
         	window.location = "AddSellingProduct.php";     
        }  
        else 
		{
        window.location = "AddSellingProduct.php";     
