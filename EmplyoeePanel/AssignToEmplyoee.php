...
<head>
      ...
      <title>Assign To Emplyoee</title>
            	...
            	<div class="row">
                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 center-block" style="float:none">
                    	<div class="x_panel m-auto">
                        	<div class="x_title">
                              <h2>Assign Emplyoee</h2>
                              <div class="clearfix"></div>
                            </div>
                            <div class="x_content">
                            	<form class="form-horizontal form-label-left" method="post" action="AssignToEmplyoeeCode.php">
                                 <div class="form-group">
                                    <label>Emplyoee</label>
                                    <input type="hidden" value="<?php echo $EmployeeUsername; ?>" name="Emp"/>
