...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        var g = {
                ...
                colors: ["rgba(1,101,208,0.9)", "rgba(1,101,208,1)"],
                xaxis: {
                    tickColor: "rgba(51, 51, 51, 0.02)",
                    mode: "time",
                    tickSize: [1, "day"],
                    axisLabel: "Date",
            ...
            h = {
                ...
                colors: ["#0165D0", "#F9A100", "#218838", "#0165D0", "#673AB7", "#5a8022", "#2c7282"],
                shadowSize: 0,
                tooltip: !0,
                tooltipOpts: {
                    content: "%s: %y.0",
    ...
    if ("undefined" != typeof Chart && (console.log("init_chart_doughnut"), $(".canvasDoughnut").length)) {
        var a = {
            ...
            data: {
                ...
                datasets: [{
                    data: [15, 20, 30, 10, 30],
                    backgroundColor: ["#BDC3C7", "#9B59B6", "#E74C3C", "#218838", "#3498DB"],
...
function init_sparklines() {
    "undefined" != typeof jQuery.fn.sparkline && (console.log("init_sparklines"), $(".sparkline_one").sparkline([2, 4, 3, 4, 5, 4, 5, 4, 3, 4, 5, 6, 4, 5, 6, 3, 5, 4, 5, 4, 5, 4, 3, 4, 5, 6, 7, 5, 4, 3, 5, 6], {
        ...
        type: "pie",
        sliceColors: ["#218838", "#ccc", "#75BCDD", "#D66DE2"]
    ...
    if (console.log("run_charts  typeof [" + typeof Chart + "]"), "undefined" != typeof Chart) {
        ...
        if ($("#lineChart").length) {
            ...
            new Chart(f, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: "My First dataset",
                        backgroundColor: "rgba(224,146,0,0.9)",
                        ...
                        label: "My Second dataset",
                        backgroundColor: "rgba(235,0,31,0.9)",
                        borderColor: "rgb(235,0,31)",
                        pointBorderColor: "rgba(3, 88, 106, 0.70)",
                        pointBackgroundColor: "rgba(3, 88, 106, 0.70)",
                        pointHoverBackgroundColor: "#fff",
                        pointHoverBorderColor: "rgba(151,187,205,1)",
        ...
        if ($("#mybarChart").length) {
            ...
            new Chart(f, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: "# of Votes",
                        backgroundColor: "rgb(249,161,0)",
                        data: [51, 30, 40, 28, 92, 50, 45]
                    }, {
                        label: "# of Votes",
                        backgroundColor: "rgb(231,29,55)",
        ...
        if ($("#canvasDoughnut").length) {
            var f = document.getElementById("canvasDoughnut"),
                i = {
                    labels: ["Yellow", "Purple Color", "Gray Color", "Green Color", "Blue Color"],
                    datasets: [{
                        data: [120, 50, 140, 180, 100],
                        backgroundColor: ["rgb(249,161,0)", "rgb(103,58,183)", "#BDC3C7", "rgb(33,136,56)", "rgb(1,101,208)"],
                        hoverBackgroundColor: ["rgb(249,161,0)", "rgb(103,58,183)", "#BDC3C7", "rgb(33,136,56)", "rgb(1,101,208)"]
                    }]
                };
            new Chart(f, {
                type: "doughnut",
        ...
        if ($("#canvasRadar").length) {
            var f = document.getElementById("canvasRadar"),
                i = {
                    ...
                    datasets: [{
                        label: "My First dataset",
                        backgroundColor: "rgba(249,161,0,0.6)",
                        borderColor: "rgb(249,161,0)",
                        ...
                        label: "My Second dataset",
                        backgroundColor: "rgba(231,29,55,0.6)",
                        borderColor: "rgb(231,29,55)",
        ...
        if ($("#pieChart").length) {
            var f = document.getElementById("pieChart"),
                i = {
                    ...
                    labels: ["Yellow", "Purple", "Gray", "Green", "Blue"]
                };
            new Chart(f, {
                data: i,
                type: "pie",
...
function init_morris_charts() {
    "undefined" != typeof Morris && (console.log("init_morris_charts"), $("#graph_bar").length && Morris.Bar({
        ...
        labels: ["Geekbench"],
        barRatio: .4,
        barColors: ["#218838", "#1A0353", "#ACADAC", "#3498DB"],
        xLabelAngle: 35,
        hideHover: "auto",
        resize: !0
        ...
        lineColors: ["#218838", "#1A0353", "#ACADAC", "#3498DB"],
        ...
        colors: ["#218838", "#1A0353", "#ACADAC", "#3498DB"],
...
function init_echarts() {
    if ("undefined" != typeof echarts) {
        ...
        var a = {
            color: ["#218838", "#1A0353", "#BDC3C7", "#3498DB", "#9B59B6", "#8abb6f", "#759c6a", "#bfd3b7"],
            title: {
                itemGap: 8,
                textStyle: {
                    fontWeight: "normal",
...
$.fn.popover.Constructor.prototype.leave = function(a) {
    ...
    init_sparklines(), init_flot_chart(), init_sidebar(), init_wysiwyg(), init_InputMask(), init_JQVmap(), init_IonRangeSlider(), init_ColorPicker(), init_TagsInput(), init_parsley(), init_daterangepicker(), init_daterangepicker_right(), init_daterangepicker_single_call(), init_daterangepicker_reservation(), init_SmartWizard(), init_EasyPieChart(), init_charts(), init_echarts(), init_morris_charts(), init_skycons(), init_select2(), init_validator(), init_DataTables(), init_chart_doughnut(), init_gauge(), init_starrr(), init_calendar(), init_compose(), init_CustomNotification(), init_autosize(), init_autocomplete(),closemenu(),stickymenu()
});


function closemenu(){
    if($('body').hasClass('top-bar-menu')){
        $('#sidebar-menu .side-menu li.active .child_menu').css('display', 'none');
        $('#sidebar-menu .side-menu li').removeClass('active');
    }
}
function stickymenu(){
    var topnvht = $('.top_nav').height();
    $(window).on('scroll', function(){
        if($(window).scrollTop() > topnvht){
            $('.sticky-hormenu').addClass('stick');
        }else{
            $('.sticky-hormenu').removeClass('stick');
        }
    });
}
